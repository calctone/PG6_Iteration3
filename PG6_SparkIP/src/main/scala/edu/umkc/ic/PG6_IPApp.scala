...
/**
 * Created by Group 6 on 07/26/15.
 */
...
object PG6_IPApp {
  ...
  val IMAGE_CATEGORIES = List(/*"accordion", "airplanes", "ant", */"open_door", "cane"/*"closed_door"*/)
  ...
  def classifyImage(sc: SparkContext, path: String) : Unit = {
    ...
    TwilHelper.sendMessage(IMAGE_CATEGORIES(p.toInt))
  ...
  def main(args: Array[String]) {
    ...
    val ip = InetAddress.getByName("192.168.1.72").getHostName//"192.168.1.72").getHostName
